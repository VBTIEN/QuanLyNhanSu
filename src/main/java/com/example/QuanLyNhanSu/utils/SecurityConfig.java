...
import com.example.QuanLyNhanSu.services.CustomUserDetailService;
...
public class SecurityConfig {
  ...
  public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
    return http.csrf().disable().authorizeHttpRequests(auth -> auth.requestMatchers("/css/**", "/js/**", "/", "/register", "/error").permitAll()
            .requestMatchers("/nhanviens/edit", "/nhanviens/delete").authenticated()
            .requestMatchers("/nhanviens", "/nhanviens/add").authenticated()
